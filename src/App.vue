...
const updateTheme = () => {
  ...
  root.style.setProperty('--text-color', mixColor(palette.ink, palette.paperStrong, 0.04))
  ...
  root.style.setProperty('--text-strong', mixColor(palette.ink, palette.paperStrong, 0.08))
